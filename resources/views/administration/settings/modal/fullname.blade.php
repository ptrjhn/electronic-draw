    ...
    <div class="uis-modal-dialog">
        <div class="uis-modal-body">
            ...
            <div class="uis-margin-medium-top">
                {!! Form::open(['class' => 'uis-form-stacked', 'id' => 'fullname-form', 'action' =>
                'SettingController@updateFullname', 'method' => 'POST']) !!}

                <div class="uis-margin">
                    <label class="uis-form-label" for="first-name">
                        First name
                    </label>
                    <input id="first-name" type="text" class="uis-input" value="{{auth()->user()->first_name}}"
                        name="first_name" placeholder="ex: John Doe">
                    <small class="uis-text-danger form-error"></small>
                </div>
                <div class="uis-margin">
                    <label class="uis-form-label" for="last-name">
                        Last name
                    </label>
                    <input id="last-name" type="text" class="uis-input" value="{{auth()->user()->last_name}}"
                        name="last_name" placeholder="ex: John Doe">
                    <small class="uis-text-danger form-error"></small>
                </div>
