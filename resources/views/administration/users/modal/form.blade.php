    ...
    <div class="uis-modal-dialog">
        <div class="uis-modal-body">
            ...
            <div class="uis-margin-top">
                {!! Form::open(['class' => 'uis-form-stacked', 'id' => 'user-form', 'action' =>
                'API\Administration\UserController@store', 'method' => 'POST']) !!}

                <div class="uis-margin">
                    <label class="uis-form-label" for="firstname">
                        First name
                    </label>
                    <input id="firstname" type="text" class="uis-input" name="first_name" placeholder="ex: John">
                ...
                <div class="uis-margin">
                    ...
                    <input id="lastname" type="text" class="uis-input" name="last_name" placeholder="ex: Doe">
