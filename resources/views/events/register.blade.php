...
<div class="uis-event">
    <header class="uis-event-header">
        <img src="{{ asset('static/logo/GMI-h-inverse.svg') }}" alt="GMI Logo Inverse">
    </header>
    ...
    <section class="uis-event-container" style="margin-top: 100px;">
        <div class="uis-card
            ...
            <div class="uis-card-body">
                ...
                {!! Form::open(['class' => 'uis-form-stacked uis-margin-medium-top', 'id' => 'event-registration-form',
                'action' => 'API\RaffleManagementController@register', 'method' => 'POST']) !!}
                <fieldset class="uis-fieldset">
                    <div class="uis-margin">
                        <label for="full-name" class="uis-form-label">
                            Full name
                        </label>

                        <input id="full-name" type="text" class="uis-input" name="full_name" placeholder="ex: John Doe"
                            required autofocus>
                        <small class="uis-text-danger form-error"></small>
                    </div>

                    <div class="uis-margin">
                        <label for="company-name" class="uis-form-label">
                            Company
                        </label>

                        <input id="company-name" type="text" class="uis-input" name="company"
                            placeholder="ex: GigaMare Inc" required>
                        <small class="uis-text-danger form-error"></small>
                    </div>

                    <div class="uis-margin">
                        <label for="email-address" class="uis-form-label" required>
                            Email address
                        </label>

                        <input id="email-address" type="email" class="uis-input" name="email"
                    ...
                    <label>
                        <input type="checkbox" class="uis-checkbox" id="terms-and-condition" required>
            ...
            <div class="uis-card-body uis-text-center">
                ...
                <div class="uis-margin-medium-top">
                    ...
                    <p>The <span class="uis-text-primary">Crew Connect 2019</span> event raffle registration is already
                        done.</p>
                </div>
            </div>
