...
<div class="uis-auth">
    <div class="uis-auth-container">
        ...
        <div class="uis-card
                uis-card-default
                uis-width-1-1">
            {!! Form::open(['class' => 'uis-form-stacked', 'id' => 'login-form', 'action' =>
            'Auth\LoginController@login', 'method' => 'POST']) !!}
            <div class="uis-card-body">
                <div class="uis-text-center">
                    <img src="{{ asset('static/logo/logo.png') }}" alt="PMPC Logo" width="150px">
                </div>
                ...
                <fieldset class="uis-fieldset
                    ...
                    <div class="uis-margin-top">
                        ...
                        <input id="password" type="password" class="uis-input" name="password"
