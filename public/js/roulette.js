...
(function($) {
    ...
    var Roulette = function(options) {
		...
		var p = $.extend({}, defaultSettings, options, defaultProperty, result);
		...
		var slowDownSetup = function() {
			...
			if (p.stopImageNumber != null) {
                p.maxDistance += (p.totalHeight - (p.maxDistance % p.totalHeight) +
		...
		var start = function() {
            ...
            p.stopImageNumber =  p.stopImageNumber;
            result = result.concat(p.stopImageNumber);
            console.log(result);
